...
namespace pwhash_scrypt
{
    ...
    tv3(void)
    {
        ...
        do {
            ...
            if (crypto_pwhash_scryptsalsa208sha256_str_verify(
                ...
                DebugPrint("pwhash_str failure: [%u]\n", (unsigned int) i);
            }
            sodium_free(out);
            sodium_free(passwd);
        } while (++i < (sizeof tests) / (sizeof tests[0]));
    ...
    str_tests(void)
    {
        ...
        if (crypto_pwhash_scryptsalsa208sha256_str_verify(str_out, passwd,
                                                          strlen(passwd)) != 0) {
            DebugPrint("pwhash_str_verify failure\n");
        }
        if (crypto_pwhash_scryptsalsa208sha256_str_verify(str_out, passwd,
                                                          strlen(passwd)) != 0) {
            DebugPrint("pwhash_str_verify failure\n");
        ...
        TEST_ASSERT(str_out[crypto_pwhash_scryptsalsa208sha256_STRBYTES - 1U] == 0);

        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_str_needs_rehash
               (str_out, 0, 0) == 1);
        TEST_ASSERT(crypto_pwhash_str_needs_rehash(str_out, 0, 0) == -1);
        TEST_ASSERT(crypto_pwhash_str_needs_rehash(str_out, OPSLIMIT, MEMLIMIT) == -1);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_str_needs_rehash
               ("", OPSLIMIT, MEMLIMIT) == -1);
    ...
    test(void)
    {
        ...
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_bytes_min() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_bytes_max() >
               crypto_pwhash_scryptsalsa208sha256_bytes_min());
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_passwd_max() >
               crypto_pwhash_scryptsalsa208sha256_passwd_min());
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_saltbytes() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_strbytes() > 1U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_strbytes() >
               strlen(crypto_pwhash_scryptsalsa208sha256_strprefix()));

        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_opslimit_min() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_opslimit_max() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_memlimit_min() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_memlimit_max() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_opslimit_interactive() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_memlimit_interactive() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_opslimit_sensitive() > 0U);
        TEST_ASSERT(crypto_pwhash_scryptsalsa208sha256_memlimit_sensitive() > 0U);
