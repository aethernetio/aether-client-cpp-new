...
#ifndef AETHER_CRYPTO_HYDROGEN_HYDRO_ASYNC_CRYPTO_PROVIDER_H_
#define AETHER_CRYPTO_HYDROGEN_HYDRO_ASYNC_CRYPTO_PROVIDER_H_
...
#endif  // AETHER_CRYPTO_HYDROGEN_HYDRO_ASYNC_CRYPTO_PROVIDER_H_
